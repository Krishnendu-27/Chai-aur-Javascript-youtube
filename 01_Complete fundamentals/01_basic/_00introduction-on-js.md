in erlier days js only run in the browser there no standalone software but now we can run js in our compiler by the help of difrent compiler nodejs dino
there come v8 
What is V8?
